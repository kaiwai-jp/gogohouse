<template>
  <div class="container">
    <div>
      ...
      <ul class="words">
        <li>
          自分のルームを作り、Twitterフォロワーを誘ってルームに入ると、音声トークをすることができます。（聴くだけも可）<br /><br />
          ルームに入れるのをTwitter相互フォローさん限定にしたり、指定した人だけがしゃべられるようにするなど細かく管理できるのが特徴です。
        </li>
      </ul>
      ...
      <ul class="words">
        ...
        <li>
          ...
          <img class="annotation" src="/help/member_star.png" /><br />
      ...
      <ul class="words">
        <li>
          <strong>
            ...
            会社内ネットワークや会社支給のパソコンだと失敗率が比較的高いです</strong
          >（中継サーバーを立てる予定）
        </li>
        <li>iPhoneで相手の音が小さくしか聞こえないことがある</li>
        ...
        <li>
          iOSの制限により画面が暗くなって音声が止まってから復旧するには、
          debugボタンを押して出てくる無音再生ボタンをタップする必要があります（改良予定）
        </li>
        <li>
          Twitter
          APIの制限により、ソーシャルルームの入場判定をするのに時間あたり回数制限があります
        </li>
